   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <img src="uploads/<?= $data['images']; ?>" alt="">
            ...
            <div class="name" style="font-size: 1.6rem; opacity: 70%;">Engine: <?= $data['engine']; ?></div>
         <div class="flex">
            <div class="price"><span>₹</span><?= $data['price']; ?></div>
<a href="addtowishlist.php?cid=<?php echo $data['id']?>&cname=<?php echo $data['name']?>&cimage=<?php echo $data['images']?>&cprice=<?php echo $data['price']?>">WISH</a>
