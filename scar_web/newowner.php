...
if (isset($_POST['submit'])) {
	...
	if ($password == $cpassword) {
		...
		if (!$result->num_rows > 0) {
			$sql = "INSERT INTO owners (username, email, password)
...
header("Location: login.php");
			...
			echo "<script>alert('This account is already Registered try another')</script>";
		}
...
<body>
	<div class="container">
		<form action="" method="POST" class="login-email">
			...
			<p class="login-register-text">Already a user? <a href="login.php">Go here</a>.</p>
		</form>
	</div>
